...
const en = {
  ...
  settings: {
    ...
    replies_show_all: 'Show all replies',
    replies_show_following: 'Only show replies to users you\'re following',
    replies_show_undirected: 'Only show undirected replies (follow up posts) or replies to you',
